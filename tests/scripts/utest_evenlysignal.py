...
s.get_duration() # TODO: 1/fsamp in piu'
...
s_down.get_end_time() # TODO: ritorna un dt=1/fsamp in piu' 
s_down.get_metadata()
s_down.plot() # TODO: dovrebbe mettere sulle x il tempo
...
s_up.get_end_time() # TODO: ritorna un dt=1/fsamp in piu' 
s_up.get_metadata()
s_up.plot() # TODO: dovrebbe mettere sulle x il tempo