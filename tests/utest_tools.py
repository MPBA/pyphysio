...
# TEST PeakDetection
mx, mn, ignored, ignored = ph.PeakDetection(deltas=rng_bvp * 0.7)(bvp)

mx2, mn2, ignored, ignored = ph.PeakDetection(delta=0.02)(eda)
...
# TEST Maxima
mx = ph.Maxima(method='complete', win_len=2, win_step=1)(eda)  # TODO: che senso ha il windowing?
