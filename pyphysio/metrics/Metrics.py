...
def compute_TE(x, y, history=1, kernelwidth=0.5):
    import jpype
    print('Joseph T. Lizier, "JIDT: An information-theoretic toolkit for studying the dynamics of complex systems",'
...
def compute_DTW(x, y, method="Euclidean", step='symmetric2', wtype="none", keep=True, distanceonly=False, openend=False,
                openbegin=False, wsize=5):  # TODO: complete
    ...
    try:
        ...
        print('Errors in importing "dtw" R package. ImportError: %s' % e.message)
        return {}
