...
class SampleEntropy(_Indicator):
    ...
    def algorithm(cls, data, params):
        ...
        if len(data) < 4:
            ...
            r = r * _np.std(data)
            d_m = _cd(uj_m, uj_m, 'chebyshev') # TODO: mettere questo come algoritmo esterno per sfruttare la cache (usato anche da approxEntropy)
            d_m1 = _cd(uj_m1, uj_m1, 'chebyshev') # TODO: mettere questo come algoritmo esterno per sfruttare la cache (usato anche da approxEntropy)
