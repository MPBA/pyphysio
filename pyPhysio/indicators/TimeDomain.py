...
class Mean(_Indicator):
    ...
    def algorithm(cls, data, params):
        return _np.nanmean(data.get_y_values())
...
class Min(_Indicator):
    ...
    @classmethod
    def algorithm(cls, data, params):
        return _np.nanmin(data.get_y_values())
...
class Max(_Indicator):
    ...
    @classmethod
    def algorithm(cls, data, params):
        return _np.nanmax(data.get_y_values())
...
class Median(_Indicator):
    ...
    @classmethod
    def algorithm(cls, data, params):
        return _np.median(data.get_y_values())
...
class StDev(_Indicator):
    ...
    @classmethod
    def algorithm(cls, data, params):
        return _np.nanstd(data.get_y_values())
...
class Sum(_Indicator):
    ...
    @classmethod
    def algorithm(cls, data, params):
        return _np.nansum(data.get_y_values())
